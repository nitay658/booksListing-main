...
class _SecondPageState extends State<SecondPage> {
  ...
  void initState() {
    ...
    _getToReadBooks();
    _localResultsEmpty = _booksToRead.isEmpty;
  ...
  _onSearchTextChanged() {
    ...
    List<Book> localResults = _booksToRead
        ...
        .toList();
    bool flag = localResults.isEmpty;
    print("localResults.isEmpty: $flag");
  ...
  _getToReadBooks() async {
    ...
    allbookslst.listen((List<Book> run) {
      setState(() {
    ...
    lst.listen((List<Book> run) {
      setState(() {
        ...
        // Check if _booksToRead is empty and print the result
        bool b = _booksToRead.isEmpty;
        print("_booksToRead.isEmpty:  $b");
      });
    });
  }
